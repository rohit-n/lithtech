...
CUI_RESULTTYPE CUIWidgetManager::SetFocusWidget(CUIBase* widget)
{
	...
	LT_MEM_TRACK_ALLOC(lost_focus_message = new CUIMessage(CUIM_LOST_FOCUS, m_pFocusWidget, m_pFocusWidget, (uintptr_t)m_pFocusWidget, 0),LT_MEM_TYPE_UI);
	...
	LT_MEM_TRACK_ALLOC(got_focus_message =	new CUIMessage(CUIM_GOT_FOCUS, widget, widget, (uintptr_t)widget, 0),LT_MEM_TYPE_UI);
